                        ...
                        <form id="edit_client_form" name="edit_app_form">
                          ...
                          <div class="form-group">
                                ...
                                <div class="input-with-icon  right">                                       
                                    <i class=""></i>
                                    <input id="app_name" class="form-control" type="text" name="app_name" value="<?php echo $app->app_name; ?>" style="width: 50%">                              
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-with-icon  right">                                       
                                    <i class=""></i>
                                    <input id="app_description" class="form-control" type="text" name="app_description" value="<?php echo $app->app_description; ?>" style="width: 50%">                              
                                </div>
                            </div>
