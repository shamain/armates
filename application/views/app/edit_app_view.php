        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Edit App Details</h3>
                </div>
                <form role="form" id="edit_app_form" name="edit_app_form">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="app_name">App Name</label>
                            <input id="app_name" class="form-control" type="text" name="app_name"  style="width: 50%" value="<?php echo $app->app_name ?>"> 
                        </div>

                        <div class="form-group">
                            <label for="app_description">App Description</label>
                            <textarea id="app_description" class="form-control" type="text" name="app_description"  style="width: 50%"><?php echo $app->app_description ?> 
                            </textarea>
                        </div>
                        ...
                        <script type="text/javascript">
                            ...
                            $(function() {
                                ...
                                new AjaxUpload(btnUpload, {
                                    action: '<?PHP echo site_url(); ?>/app/app_controller/update_app_scenes',
                                    name: 'uploadfile',
